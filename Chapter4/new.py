...
_taxi_module_file_param = data_types.RuntimeParameter(
    name='module-file',
    default='gs://<BUCKET_NAME>/tfx_taxi_simple/modules/taxi_utils.py',
    ptype=Text,
)
...
if __name__ == '__main__':
 ...
 # metadata_config.grpc_config.grpc_service_host.value ='metadata-grpc-services'
  ...
  kfp_runner = kubeflow_dag_runner.KubeflowDagRunner(
      output_filename='pipe9' + '.yaml', config=config
  )
